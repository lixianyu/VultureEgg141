...
#define ST_CONTINUE_SEND_TEMP_NOTI_EVT                        0x0002
#define ST_CONN_PARAM_UPDATE_EVT                      0x0004
...
typedef enum
{
    ...
    REQUEST_MPU6050_CMD_ID = 0x04,
    REQUEST_MPU6050_CMD_ID_E = 0x03,
    
    RETURN_TEMPERATURE_CMD_ID = 0x05,
    RETURN_HUMIDITY_CMD_ID = 0x06,
    RETURN_MPU6050_CMD_ID = 0x07,
    
    RETURN_ERROR_CMD_ID = 0x08,
